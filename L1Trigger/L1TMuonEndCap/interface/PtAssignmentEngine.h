...
public:
  ...
  virtual float calculate_pt(const EMTFTrack& track, const int shower_bit) const;
  ...
  virtual float calculate_pt_xml(const EMTFTrack& track, const int shower_bit) const { return 0.; }
