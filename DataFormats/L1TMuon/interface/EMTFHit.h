...
namespace l1t {
  ...
  public:
    ...
    void set_unp_sector(int bits) { unp_sector = bits; }
    ...
    int Unp_Sector() const { return unp_sector; }
  ...
  private:
    ...
    int unp_sector;      ///<  1 -  6.  CSC / GEM / EMTF sector convention: sector 1 starts at 15 degrees
